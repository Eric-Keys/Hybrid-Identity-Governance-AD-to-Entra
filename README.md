...
- **Failure Simulation:** Performed a "Pull-the-Plug" test by removing a drive from the VM. Verified data persistence on the surviving mirror and documented the process of initializing a new drive to rebuild the array. <img src="images/Screenshot%202026-04-16%20125220.png" width="800">
- **Network Persistence:** Resolved a VMware NAT service failure and configured a static IPv4 stack with loopback DNS to ensure DC stability. <img src="images/Screenshot%202026-04-20%20114957.png" width="800" height="600">
</details>
